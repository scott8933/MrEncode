...
struct MediaItem: Identifiable, Equatable {
    ...
    // Ingestion batching (droplet drop group, watch-folder batch, etc.)
    var ingestGroupID: String? = nil
    ...
    mutating func clearCachedDstLine() { _cachedDstLine = nil }
    mutating func clearCachedLines() {
        _cachedSrcLine = nil
        _cachedDstLine = nil
    }

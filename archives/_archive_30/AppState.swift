...
final class AppState: ObservableObject {
                     ...
                     logURL: URL? = nil)
    {
        ...
        // Debug: Print when we add messages with logURL or detail
        if logURL != nil || detail != nil {
            print("📝 Added message with logURL: \(logURL?.path ?? "nil"), detail: \(detail?.isEmpty == false ? "present" : "nil")")
        }
    }

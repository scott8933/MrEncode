...
private struct UI_QueueRow: View {
    ...
    /// Build an actual (non-estimated) output line from the encoded file.
    /// "Output: 1920×1080 • Rec.709 [1, 1, 1] • 12.3 Mbps • 1.25 GB"
    private func buildActualOutputLine(finalURL: URL,
                                       nclcLabel: String?,
        ...
        // Use the *final* asset's geometry and duration for true values
        let size = vTrack.naturalSize.applying(vTrack.preferredTransform)

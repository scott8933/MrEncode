...
struct UI_PresetsDroplets: View {
    ...
    var body: some View {
            ...
            Button {
                ...
                HStack(spacing: StyleConstants.headerSpacing) {
                    ...
                    Menu {
                        ...
                        .onHover { hovering = $0 }
                        .animation(.easeInOut(duration: StyleConstants.hoverAnimationDuration), value: hovering)
                    }
                    .buttonStyle(.plain)
        ...
        .animation(.easeInOut(duration: StyleConstants.expandAnimationDuration), value: isExpanded)
        .onAppear {
...
private struct PresetInfo: View {
    var body: some View {
        VStack(alignment: .leading, spacing: 4) {
            ...
            Text("• Drag .mov files onto a .mrencode droplet file to process with those settings")
        }
        .font(.caption)
        .foregroundColor(.secondary)
        .padding(.top, 4)

...
enum EncodeRemote {
    ...
    static func writeFFmpegJobBundlesToDesktop(items: [MediaItem],
        ...
        for item in items {
            ...
            let outputArgs = FFmpegCommandBuilder
                .ffmpegOutputArgs(fromFullArgs: args, input: input, output: output)
    ...
    static func submitFFmpegJob(deadlineCmd: String,
        ...
        let outputArgs = FFmpegCommandBuilder.ffmpegOutputArgs(fromFullArgs: args, input: input, output: output)

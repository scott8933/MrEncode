...
enum FFmpegCommandBuilder {
    ...
    private static func overlayFilters(input: URL,
        ...
        func xExpr(for pos: BurnInPosition) -> String {
            ...
            case .upperCenter, .lowerCenter:
                // Center align: x = (main_w - text_w)/2
        ...
        func yExpr(for pos: BurnInPosition, idx: Int, count: Int) -> String {
            ...
            case .middleLeft, .middleRight:
                // y = (main_h - text_h)/2 + idx*lineHeight
                // NOTE: uses text_h of the current line. This stacks from the center downward.
                // If you prefer the entire stack centered around the middle, we can adjust in a follow-up.

    ...
    var body: some View {
        ...
        HStack(alignment: .firstTextBaseline, spacing: 8) {
            ...
            VStack(alignment: .leading, spacing: 6) {
                ...
                // Progress bar (shown only while encoding)
...
fileprivate extension UI_QueueRow {
    func signature(url: URL, meta: MediaMetadata) -> String {
        [
            ...
            (meta.durationSeconds > 0 ? String(format: "%.3f", meta.durationSeconds) : "-")
        ].joined(separator: "|")
    }
    ...
    func buildBaseTechLine(url: URL, meta: MediaMetadata) -> String {
        ...
        let seconds = meta.durationSeconds > 0 ? meta.durationSeconds : CMTimeGetSeconds(asset.duration)

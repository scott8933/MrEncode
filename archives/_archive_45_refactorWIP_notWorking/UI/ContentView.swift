...
struct ContentView: View {
    ...
    @State private var queueHeight: CGFloat = AppColors.queueDefaultHeight // CHANGED
    ...
    var body: some View {
        ...
        .frame(minWidth: AppColors.windowMinWidth, minHeight: AppColors.windowMinHeight) // CHANGED
...
private struct ManualModeContent: View {
    ...
    private let minQueueHeight = AppColors.queueMinHeight
    private let maxQueueHeight = AppColors.queueMaxHeight
    ...
    var body: some View {
        VStack(spacing: AppColors.sectionSpacing) {
            ...
            .padding(.horizontal, AppColors.contentHorizontalPadding)
            .padding(.top, AppColors.contentVerticalPadding)
            ...
            HStack(spacing: 0) {
                ScrollView {
                    ...
                    .padding(.horizontal, AppColors.contentHorizontalPadding)
                    .padding(.vertical, AppColors.sectionSpacing)
                    .padding(.bottom, 100)
                }

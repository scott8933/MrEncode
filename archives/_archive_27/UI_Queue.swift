// =============================
// File: UI_Queue.swift  (NSTableView wrapper; variable row height; expand only down)
// =============================
import SwiftUI
import AppKit
...
struct UI_Queue: View {
    ...
    // NOTE: not private => accessible to nested types below (Coordinator uses UI_Queue.C)
    enum C {
        ...
        static let rowH_collapsed: CGFloat = 56
        static let rowH_expanded: CGFloat  = 128 // tune as needed
    }
